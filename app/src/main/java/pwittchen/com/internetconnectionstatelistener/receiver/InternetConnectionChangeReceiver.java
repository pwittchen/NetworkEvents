...
public class InternetConnectionChangeReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        if (intent.getAction().equals(StringHelper.getString(R.string.internet_connection_state_change_intent))) {
            boolean connectedToInternet = intent.getBooleanExtra(StringHelper.getString(R.string.internet_connection_intent_extra), false);
